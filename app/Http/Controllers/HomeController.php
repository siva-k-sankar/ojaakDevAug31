...
class HomeController extends Controller
{
    ...
    {
        $this->middleware(['auth'], ['except' => ['ajaxotp','ajaxemailupdate','referralregister','registercheck','mobile_verify_reg','ajaxmobilecheck','ajaxreportusersubmit','ajaxreportadssubmit','welcome','useravailable','emailregister','mobileregister','searchlocation','search','getlanlat','invalidLoginError']]);
    }
