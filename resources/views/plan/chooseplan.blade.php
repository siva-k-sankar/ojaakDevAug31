                                        ...
                                        @foreach($freeplans as $freeplan)
                                            @if($freeplan->plan_name == 'Free Plan')
                                                <div class="plan_content_header">
                                                    @foreach($plansdetails as $plansdetail)
                                                        @if($plansdetail->plan_id == $freeplan->id)
                                                        @php //echo "<pre>";print_r($freeplan);die; @endphp
                                                        <h4 style="font-size: 14px;color: #666;">Free</h4>
                                                        <h4 style="font-size: 14px;color: #666;">{{$freeplan->ads_points}} Points</h4>
                                                        <h4 style="font-size: 14px;color: #666;">{{($freeplan->ads_points/$ads_view_point)}} Views</h4>
                                                        <h4 style="font-size: 14px;color: #666;">{{$freeplan->validity}} Days</h4>
                                                        <h4 style="font-size: 14px;color: #666;">-</h4>
                                                        <h4 style="font-size: 14px;color: #666;">Ad points only for first 5 ad per 30days</h4>
                                                        <h4 style="border: 0px;"> 
                                                            <div class="plans_footer_row">
                                                                <div class="plan_table_btn"> 
                                                                <a onclick="confirmFreePlan(event)" href="{{route('plans.order',[$freeplan->uuid,base64_encode($plansdetail->id)])}}"  >
                                                                    <p>Post Free Ad</p>
                                                                </a>
                                                                </div>
                                                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            @foreach($plans as $plan)
                                                ...
                                                <?php $j++;?>
                                                <!--  -->
                                                <a href="javascript:void(0);" class="checkPlanAvail" onclick="confirmplan('{{route('ads.selectPlanPost',$plan->uuid)}}');"><p>{{getpaidplanname($plan->plan_id)}} </p>
