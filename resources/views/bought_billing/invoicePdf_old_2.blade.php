...
<head>
    ...
    <style type="text/css">
        ...
        .total_amount_outer_wrap h4 {font-size: 20px; font-weight: 900; color: #f00; margin: 0;}
        ...
        .left_col_content_wrap span {color: #666; font-size: 14px; }
        .right_col_content_wrap span {color: #000; font-weight: 600; font-size: 14px; }
        ...
        .estimate_left_col h5 {margin: 0; font-size: 14px; color: #666;  }
        .estimate_right_col tr strong {text-align: center; padding: 7px 0; display: block; }
        .estimate_right_col td {text-align: center; }
        .term_cond_left_col {width: 63%; }
        .term_cond_left_col h5 {margin: 0; font-size: 17px; padding-bottom: 9px; font-weight: 800; }
        .term_cond_left_col p {margin: 0; color: #666; padding-bottom: 10px;line-height: 25px;  font-size: 14px; }
        ...
        .estimate_left_col td strong {font-size: 14px; }
        td.border_line_wrap {width: 38%; }
...
<body>
    <div class="invoice_outer_wrap">
            ...
            <tr>
                <td colspan="2" class="customer_info_logo_wrap">
                    <div class="billing_logo_img_wrap">
                        <img src="{{ asset('public/frontdesign/assets/img/ojaak_logo.png') }}">
                    </div>
                </td>
        ...
        <table class="bill_table_outer_wrap">
            ...
            <tr>
                ...
                <th rowspan="2"><span>Transaction</span><p>Value</p></th>
                <th colspan="2" scope="colgroup"><span>IGST</span></th>
            ...
            <tr class="bill_table_inner_wrap">
                <td><span>1</span></td>
                <td><span>9933</span></td>
                <td><span>{{$information}}</span></td>
                <td><span>3</span></td>
                <td><span>{{$payment}}.00</span></td>
                <td><span>384.45</span></td>
                <td><span>0.0</span></td>
                <td><span>336.14</span></td>
                <td><span></span></td>
                <td><span></span></td>
    ...
    width: 100%;">
                        <tr>
                            <td><h5>Total SGST Amount</h5></td>
                            <td><strong>{{$totalinvoiceamut}}</strong></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><h5>Total CGST Amount</h5></td>
                            <td><strong>{{$totalinvoiceamut}}</strong></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><h5>Total IGST Amount</h5></td>
                            <td><strong>{{$totalinvoiceamut}}</strong></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><h5>Total Invoice Amount</h5></td>
                            <td><strong>{{$totalinvoiceamut}}</strong></td>
                            <td></td>
                        </tr>
                    </table>
                </td>
                <td class="estimate_outer_wrap">
                    <table class="estimate_right_col">
                        <thead>
                            <tr>
                                <td style="width: 177px;">SGST Amount</td>
                                <td style="width:89px;">30.43</td>
                            </tr>
                            <tr>
                                <td>CGST Amount</td>
                                <td>30.43</td>
                        ...
                        <tr>
                            ...
                            <td><strong>INR <span>{{$payment}}.00</span></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
