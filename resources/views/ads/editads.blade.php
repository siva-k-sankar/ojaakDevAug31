...
<!-- Add Ads -->
    <div class="container-fluid pl-0 pr-0 add_ads_outer_wrap">
        <div class="box-size add_ads_bg_wrap">
            
            <form action="{{route('ads.user.free.update')}}" id="updateads" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div id="postdiv"  style="" class="row ads_form_field_wrap">
                    ...
                    <div class="col-lg-6 col-md-6 pl-0 ads_post_common_pad_wrap">
                        ...
                        <div class="form-group fields_common_wrap" id='seller_name'>
                            ...
                            <input type="text" class="form-control  @error('sell-phone') is-invalid @enderror"  value="<?php if(Auth::check())
                        ...
                        <div class="form-group fields_common_wrap" id='seller_phone'>
                            ...
                            <input type="tel" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" title="Please enter 10 digit valid mobile number"class="form-control  @error('sell-phone') is-invalid @enderror"  value="<?php if(Auth::check())
