                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 single_billing_col_right">
                                        ...
                                        <div class="use_purchase_wrap">
                                            <span class="used_inner_wrap" @if($plan->type == '0') onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','0')" @elseif($plan->type == '1') onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','1')" @else onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','2')"  @endif >{{$plan->ads_limit - $plan->ads_count}} used</span>
                            ...
                            <div class="single_billing_product">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 single_billing_col_right">
                                        ...
                                        <div class="use_purchase_wrap">
                                            <span class="used_inner_wrap" @if($plan->type == '0') onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','0')" @elseif($plan->type == '1') onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','1')" @else onclick="viewadeslist('{{$plan->id}}','{{$plan->plan_id}}','2')"  @endif >{{$plan1->ads_limit - $plan1->ads_count}} used</span>
