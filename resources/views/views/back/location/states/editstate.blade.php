            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <form action="{{route('admin.location.updatestate')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a style="margin: 3px;"class="btn btn-primary" href="{{route('admin.location.state',$countryid)}}">Back</a>
