                        ...
                        <div class="show_contact_detail_wrap form-group">
                            ...
                            <div class="show_detail_inner_wrap">
                                ...
                                <label class="switch">
                                  ...
                                  <input type="checkbox"  @if($notification->recommendations ==  1) checked @endif name="recommend" value="1">
                        ...
                        <div class="show_contact_detail_wrap form-group">
                            ...
                            <div class="show_detail_inner_wrap">
                                ...
                                <label class="switch">
                                  ...
                                  <input type="checkbox"  @if($notification->offers ==  1) checked @endif name="offers" value="1">
                                  <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
