                    ...
                    <div class="profile_breadcum_wrap ads_managemnet_title_wrap">
                        <nav aria-label="breadcrumb" class="page_title_inner_wrap">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">Work Mail Updation</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 profile_right_col">
                    <div class="profile_form_fields_outer_wrap">
                        <form role="form" action="{{route('profile.workmail.update')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    @if(Auth::user()->work_mail !="")
                                        <div class="fields_common_wrap form-group">
                                            <label>Current Work Mail Id Is : {{ Auth::user()->work_mail }}</label>
                                        </div>
                                    @else
                                        <div class="fields_common_wrap form-group">
                                            <label>Work Mail Id Is Not Registered</label>
                                        </div>
                                    @endif
                                </div>  
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="fields_common_wrap form-group" id="mail-form" style="display:none;">
                                        <label>Enter Work Mail Address</label>
                                        <input  type="email" name="mail" required value="" required class="form-control">
                                    </div>
                                </div>  
                            </div>
                            <div class="row ">
                                <div class="col-md-4 common_btn_wrap contact_submit_btn_wrap">
                                    ...
                                    <button type="submit" id="update"class="">Update  Work Mail</button>
                                </div>  
                            </div>
                        </form>
                    </div>
