                    ...
                    <div class="profile_form_fields_outer_wrap">
                        <form role="form" action="{{ route('profile.updatepassword') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row" style="margin-bottom: 15px !important;">
                                <div class="col-md-6">
                                    <div class="fields_common_wrap form-group">
                                        <input type="password" name="old" value="" placeholder="Current Password" required class="form-control" id="current_password">
                                    </div>
                                </div>  
                            </div>
                            <div class="row" style="margin-bottom: 15px !important;">
                                <div class="col-md-6">
                                    <div class="fields_common_wrap form-group">
                                        <input type="password" name="new"  placeholder="New Password" value="" required class="form-control"  id="new_password">
                                    </div>
                                </div>  
                            </div>
                            <div class="row ">
                                <div class="col-md-6">
                                    <div class="fields_common_wrap form-group">
                                        <input type="password" placeholder="Confirm Password"name="confirm" value="" required class="form-control" id="confirm_new_password">
                                    </div>
                                </div>  
                            </div>
                            <div class="row ">
                                <div class="col-md-4 common_btn_wrap contact_submit_btn_wrap">
                                    <button type="submit" class="save" disabled="">Change Password</button>
                                </div>  
                            </div>
                        </form>
                    </div>
...
<script>
 $(document).ready(function(){
        $( "#current_password,#new_password,#confirm_new_password" ).on('change',function() {
