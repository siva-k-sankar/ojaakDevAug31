            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="m-2" >
                        ...
                        <div class="login_ojaak_img_wrap">
                        ...
                        <form class="py-4" id="Hregisterform" method="POST" action="" style="display: none;">
                             @csrf
                            <div class="form-group">
                                <input id="remail" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Enter  Email" autofocus="autofocus" name="email" value="{{ old('email') }}" required autocomplete="off">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group " >
                                <div class="col-md-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="terms">By Accepting <a href="{{route('termscondition')}}">Terms and condition</a></label>
                                    </div>
                                </div>
                            </div>
                        ...
                        if(data == 0){
                            ...
                            if(passwordmatch == 1){
                                if(terms==1){
                                    ...
                                    /*$("#soname").hide();
                                    $("#titlelh").attr('style','display:none !important');
                                    $("#Hloginform").hide();
                                    $("#Hregisterform").hide();
                                    $('#Hotpform').show();
                                    $('#mob').val(rphone);
