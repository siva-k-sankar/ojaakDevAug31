            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Add a new paid Plan<span></span></h3>
                </div>
                <!-- /.box-header -->
                <form action="{{route('admin.paidadsplans.add')}}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="box-body">
                            ...
                            <div class="form-group @error('validity') has-error  @enderror">
                                ...
                                <input type="number" class="form-control" id="validity" placeholder="" name="validity" value="{{ old('validity') }}">
                                @error('validity')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group @error('points') has-error  @enderror">
                                ...
                                <input type="text" class="form-control" id="points" placeholder="" name="points" value="{{ old('points') }}">
                                @error('points')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group @error('quantity_1') has-error  @enderror">
                                ...
                                <input type="text" class="form-control" id="quantity_1" placeholder="" name="quantity_1" value="{{ old('quantity_1') }}">
                                @error('quantity_1')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
                             ...
                             <div class="form-group @error('quantity_3') has-error  @enderror">
                                ...
                                <input type="text" class="form-control" id="quantity_3" placeholder="" name="quantity_3" value="{{ old('quantity_3') }}">
                                @error('quantity_3')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
                             ...
                             <div class="form-group @error('quantity_5') has-error  @enderror">
                                ...
                                <input type="text" class="form-control" id="quantity_5" placeholder="" name="quantity_5" value="{{ old('quantity_5') }}">
                                @error('quantity_5')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
                             ...
                             <div class="form-group @error('quantity_10') has-error  @enderror">
                                ...
                                <input type="text" class="form-control" id="quantity_10" placeholder="" name="quantity_10" value="{{ old('quantity_10') }}">
                                @error('quantity_10')
                                    <span class="help-block" role="alert">
                                        <strong class="text-red">{{ $message }}</strong>
                                    </span>
