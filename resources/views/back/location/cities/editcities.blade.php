            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Cities<span></span></h3>
                </div>
                <!-- /.box-header -->
                
                
                    <div class="box-body">
                        <form action="{{route('admin.location.updatecities')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a style="margin: 3px;"class="btn btn-primary" href="{{route('admin.location.cities',$countryid)}}">Back</a>
