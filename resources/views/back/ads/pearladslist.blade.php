    ...
    $(document).ready(function(){
        ...
        function featuredads(){
            $('#featuredadslist').DataTable({
                ...
                "ajax": {
                    "url":"<?php echo url('admin/ads/pearlAdslist/view'); ?>",
                    "type": "POST",
                    "data": function(d) {
        ...
        function expireplan(id){
            ...
            dangerMode: true,
                ...
                if (willDelete) {
                    $.ajax({
                        url: '<?php echo url('admin/ads/pearlAdslist/expire'); ?>',
                        data:"topdata="+id+"&_token="+_token,
                        type: "post",
                        success:function(data) {
                            console.log(data);
                            if(data==1){
                                toastr.success('Success!', 'TopList Ads Remove')
                                setTimeout(function(){ location.reload(); }, 1000);
                            }else{
                                toastr.error('Failed!', 'TopList Ads Not Remove ')
                            }
                        }
                    });
                }
